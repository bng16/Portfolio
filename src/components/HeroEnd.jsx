...
function HeroEnd() {
  return (
    <div className="bg-red-500 w-full h-[60vh] rounded-3xl flex items-center overflow-hidden">
      <div className="w-full h-[70%] border-4 border-x-0">
        <h1 className="animate-moveLeft font-black text-[12vw] whitespace-nowrap text-primary">
